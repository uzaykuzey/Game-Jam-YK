...
public class IfAlivePushPlayerBack : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        if(Controller.instance.player.transform.position.x > transform.position.x && Controller.instance.player.transform.position.y > -25f && Controller.instance.player.transform.position.y < -20.66f)
        {
